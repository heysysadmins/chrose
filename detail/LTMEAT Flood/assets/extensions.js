...
async function loadExtensionButtons() {
    ...
    if (!window.chrome) {
        buttonsContainer.innerHTML =
            "<span style='color: pink;'><b>This is not a Chromium-based browser.</b></span>";
    } else if (installed.length === 0) {
        buttonsContainer.innerHTML =
            "<span style='color: pink;'>No supported extensions detected.<p style='color: gold;'>You can paste the extension's ID manually from its details page in <u>chrome://extensions</u>.</span>";
    } else {
        buttonsContainer.innerHTML = "";
    }
